...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>CHSPK MUSIC</title>
		<meta title ="Chesapeak Music">
		<meta charset="UTF-8">
	...
	Chesapeak,East,Coast,hiphop,hip,hop,music,PorterBay,porter,bay,rap,art,vinci,scrolling,twitter">
		...
		<link rel="stylesheet" type="text/css" href="style/css/examples.css" />
		<noscript>
        ...
        <link rel="stylesheet" href="style/css/contact-buttons.css">
	...
	* --------------------------------------- */
	#section1{
		background-image: url(images/content/large_back_pic_2.png);
		padding: auto;
    	-webkit-background-size: cover;
    	-moz-background-size: cover;
    	-o-background-size: cover;
	...
	#section2{
		background-image: url(images/content/freee.png);
		padding: auto;
    	-webkit-background-size: cover;
    	-moz-background-size: cover;
    	-o-background-size: cover;
	...
	* --------------------------------------- */
	#slide1{
		background-image: url(images/content/gallery1.jpg);
		padding: auto;
	}
	#slide2{
		background-image: url(images/content/gallery2.png);
		padding: auto;
	}
	#slide3{
		background-image: url(images/content/gallery3.jpg);
		padding: auto;
	}
	#slide4{
		background-image: url(images/content/gallery4.jpeg);
		padding: auto;
	}
	#slide5{
		background-image: url(images/content/gallery5.jpeg);
		padding: auto;
	}
	#slide6{
		background-image: url(images/content/gallery6.png);
		padding: auto;
	}
...
<div id="fullpage">
		...
		<div class="layer">		
			<div id="wrapper">
        		...
        		<div class="layerleft">	
            		<ul class="icons">
            			<li style="display:block; position:relative;">
            			    <a href="#twitter" class="icon fa-twitter">
            			    <span class="label"></span>
            			    </a>
            			</li>
            			<li style="display:block; position:relative;">
            			    <a href="https://facebook.com/" class="icon fa-facebook">
            			    <span class="label"></span>
            			    </a>
            			</li>
            			<li style="display:block; position:relative;">
            			    <a href="https://www.instagram.com/chspkmusic/" class="icon fa-instagram">
            			    <span class="label"></span>
            			    </a>
            			</li>
            		</ul>        		
        		...
        		<div class="layermiddle">		
					<header id="header">
						<div class="logo">
                            <img alt="" class="logo" src="images/savage_duck.png" width="100%">	
                        </div>
						<div class="content">
							<div class="inner">
								<a href = "http://chesapeakmusic.com">
								<img alt="" src="images/logo_white.png" width="300">
								</a>
							</div>
						</div>
						<nav>
                            <ul>
								...
								<li style="background-color:#0088ff; font-weight: bold;"><a href="#latest">Latest Release</a></li>
							</ul>
					...
					<div id="main">
						...
						<!-- Latest Release -->
						<article id="latest">
							<h2 class="major">Latest Release</h2><span class="image main"><img alt="" src=""></span>
							<iframe width="560" height="315" src="https://www.youtube.com/embed/SBlOKNja9uA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
						</article>

						<!-- Twitter Feed -->
						<article id="twitter">
							<h2 class="major">CHSPK</h2>
								<a class="twitter-timeline" data-width="99%" data-height="500" data-theme="dark" href="https://twitter.com/ChesapeakMusic?ref_src=twsrc%5Etfw">Tweets by ChesapeakMusic</a>
						</article>
						...
						<article id="music">
							...
							<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/503150667&color=%23645c64&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true">
							</iframe>
						</article>
					</div>
				    ...
				    <!-- Footer -->
					<footer id="footer">
					    <p class="copyright" id="copyright_hover">&copy; 2018 Chesapeak Music. All Rights Reserved</p>
					</footer>
                </div>
		        ...
		        <div class="layerright">
            		<ul class="icons">
            			...
            			<li style="display:block; position:relative;">
            			    <a href="#music" class="icon fa-music">
            			    <span class="label"></span>
            			    </a>
            		    </li> 
            			<li style="display:block; position:relative;">
                			<a href="#" class="icon fa-shopping-cart">
                			<span class="label"></span>
                			</a>
            			</li>
            		</ul>    		
	...
	<div class="section" id="section1">
	    ...
	    <center>
	        ...
	        <div class="pagetwo">
	            <h4>Tickets for Over 21</h4>
	            <a href = "https://www.paypal.com/webapps/hermes?token=2UX49239FF092242M&useraction=commit&rm=0&mfid=1542323769061_ba34ca101e4b" target = "_blank">
	            <img src = "images/paypal.png">
	            </a>
	            <br><br>
	            <h4>Tickets for Under 21</h4>
	            <a href = "https://www.paypal.com/webapps/hermes?token=39G87381N53313925&useraction=commit&rm=0&mfid=1542323770227_49069e4ba68bd" target = "_blank">
	            <img src = "images/paypal.png">
	            </a>
	        </div>
	    </center>
    ...
    <script src="style/js/jquery.contact-buttons.js">
    </script>
    <script src="style/js/demo.js">
    </script>
	...
	<script src="style/js/breakpoints.min.js">
	</script> 
	<script src="style/js/body.js">
	</script> 
