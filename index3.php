...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	*/
	...
	#section0 {
    	background-image: url(https://media.giphy.com/media/YQszQPfyhKqNq/giphy.gif);
    	-webkit-background-size: cover;
    	-moz-background-size: cover;
    	-o-background-size: cover;
    	background-size: cover;
			...
			<div id="wrapper">
        		...
        		<div class="layermiddle">		
					...
					<header id="header">
						...
						<nav>
                            <ul>
								<li style="background-color:#152E4F; font-weight: bold;"><a href="#CHSPK">CHSPK</a></li>
								<li style="background-color:#152E4F; font-weight: bold;"><a href="#drinkmorewater">Drink More Water</a></li>
